...
{
    public class WmProductReader
    {
        private IndexUtils indexUtils;
        public WmProductReader()
        {
        ...
        #region BindData
        private ProductIndexWmInfo BindData(LuceneDocument model)
        {
            var doc = model.Doc;
            ProductIndexWmInfo Info = new ProductIndexWmInfo();
        ...
        private List<ProductIndexWmInfo> BindList(List<LuceneDocument> list)
        {
            var data = new List<ProductIndexWmInfo>();
