...
using IndexFileNameFilter = Laobai.Lucene.Index.IndexFileNameFilter;
...
namespace Laobai.Lucene.Store
{
	...
	public abstract class FSDirectory : Directory
	{
		...
		/// This method should be used in <see cref="Laobai.Lucene.Store.Directory.CreateOutput(string)" />. 
		/// </summary>
		...
		protected internal FSDirectory(System.IO.DirectoryInfo path, LockFactory lockFactory)
		{
            ...
            // system property Laobai.Lucene.Store.FSDirectoryLockFactoryClass is set,
		...
		public static FSDirectory Open(System.IO.DirectoryInfo path, LockFactory lockFactory)
		{
			...
			*/
			...
			{
                //NIOFSDirectory is not implemented in Laobai.Lucene
        ...
        // For Laobai.Lucene, GetDirectory() is more appropriate
