...
namespace Laobai.Lucene.Util
{
	...
	public sealed class NumericUtils
	{
		...
		/// <see cref="Laobai.Lucene.Search.BooleanQuery" /> for each call to its
		...
		public abstract class LongRangeBuilder
		{
			...
			{
				AddRange(Laobai.Lucene.Util.NumericUtils.LongToPrefixCoded(min, shift), Laobai.Lucene.Util.NumericUtils.LongToPrefixCoded(max, shift));
			}
		}
		...
		public abstract class IntRangeBuilder
		{
			...
			{
				AddRange(Laobai.Lucene.Util.NumericUtils.IntToPrefixCoded(min, shift), Laobai.Lucene.Util.NumericUtils.IntToPrefixCoded(max, shift));
			}
		}
	}
}