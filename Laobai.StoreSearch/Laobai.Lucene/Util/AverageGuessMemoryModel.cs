...
namespace Laobai.Lucene.Util
{
	...
	public class AverageGuessMemoryModel:MemoryModel
	{
		...
		* (non-Javadoc)
		* 
		* <see cref="Laobai.Lucene.Util.MemoryModel.getArraySize()"/>
		*/
		...
		* (non-Javadoc)
		* 
		* <see cref="Laobai.Lucene.Util.MemoryModel.getClassSize()"/>
		*/
	    ...
	    /* (non-Javadoc)
		* <see cref="Laobai.Lucene.Util.MemoryModel.getPrimitiveSize(java.lang.Class)"/>
		*/
		...
		/* (non-Javadoc)
		* <see cref="Laobai.Lucene.Util.MemoryModel.getReferenceSize()"/>
		*/
