...
using DefaultSimilarity = Laobai.Lucene.Search.DefaultSimilarity;
...
namespace Laobai.Lucene.Index
{
    ...
    public class DirectoryReader:IndexReader
    {
        /*new*/ private class AnonymousClassFindSegmentsFile:SegmentInfos.FindSegmentsFile
        {
            ...
            internal AnonymousClassFindSegmentsFile(bool readOnly, Laobai.Lucene.Index.IndexDeletionPolicy deletionPolicy, int termInfosIndexDivisor, Laobai.Lucene.Store.Directory Param1):base(Param1)
            {
        ...
        private class AnonymousClassFindSegmentsFile1:SegmentInfos.FindSegmentsFile
        {
            ...
            internal AnonymousClassFindSegmentsFile1(bool openReadOnly, DirectoryReader enclosingInstance, Laobai.Lucene.Store.Directory Param1):base(Param1)
            {
        ...
        /// <throws>  Laobai.Lucene.Store.LockObtainFailedException </throws>
        ...
        /// <seealso cref="Laobai.Lucene.Index.IndexReader.ListCommits">
        /// </seealso>
