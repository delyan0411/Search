...
using Document = Laobai.Lucene.Documents.Document;
using FieldSelector = Laobai.Lucene.Documents.FieldSelector;
using Laobai.Lucene.Store;
using Similarity = Laobai.Lucene.Search.Similarity;
...
namespace Laobai.Lucene.Index
{
	...
	/// one of the static <c>open()</c> methods, e.g. <see cref="Open(Laobai.Lucene.Store.Directory, bool)" />
	///.
	...
	public abstract class IndexReader : System.ICloneable, System.IDisposable
	{
		...
		{
			private void  InitBlock(Laobai.Lucene.Store.Directory directory2)
			{
				this.directory2 = directory2;
			}
			private Laobai.Lucene.Store.Directory directory2;
			internal AnonymousClassFindSegmentsFile(Laobai.Lucene.Store.Directory directory2, Laobai.Lucene.Store.Directory Param1):base(Param1)
			{
	    ...
	    /// <see cref="Open(Laobai.Lucene.Store.Directory, bool)" />, or <see cref="Reopen()" /> 
		...
		/// <seealso cref="Laobai.Lucene.Documents.Field.TermVector">
		/// </seealso>
		...
		/// <summary> Get the <see cref="Laobai.Lucene.Documents.Document" /> at the <c>n</c>
		/// <sup>th</sup> position. The <see cref="FieldSelector" /> may be used to determine
		/// what <see cref="Laobai.Lucene.Documents.Field" />s to load and how they should
		/// be loaded. <b>NOTE:</b> If this Reader (more specifically, the underlying
		/// <c>FieldsReader</c>) is closed before the lazy
		/// <see cref="Laobai.Lucene.Documents.Field" /> is loaded an exception may be
		/// thrown. If you want the value of a lazy
		/// <see cref="Laobai.Lucene.Documents.Field" /> to be available after closing you
		...
		/// <see cref="Laobai.Lucene.Documents.Document" /> at the nth position
		/// </returns>
		/// <throws>  CorruptIndexException if the index is corrupt </throws>
		/// <exception cref="System.IO.IOException">If there is a low-level IO error</exception>
		/// <seealso cref="IFieldable">
		/// </seealso>
		/// <seealso cref="Laobai.Lucene.Documents.FieldSelector">
		/// </seealso>
		/// <seealso cref="Laobai.Lucene.Documents.SetBasedFieldSelector">
		/// </seealso>
		/// <seealso cref="Laobai.Lucene.Documents.LoadFirstFieldSelector">
		/// </seealso>
		...
		/// </summary>
        /// <seealso cref="Laobai.Lucene.Documents.AbstractField.Boost" />
        ...
        /// <summary>Returns an unpositioned <see cref="Laobai.Lucene.Index.TermDocs" /> enumerator.</summary>
        /// <exception cref="System.IO.IOException">If there is a low-level IO error</exception>
        ...
        /// <summary>Returns an unpositioned <see cref="Laobai.Lucene.Index.TermPositions" /> enumerator.</summary>
        /// <exception cref="System.IO.IOException">If there is a low-level IO error</exception>
		...
		/// </summary>
		/// <param name="args">Usage: Laobai.Lucene.Index.IndexReader [-extract] &lt;cfsfile&gt;
		/// </param>
		[STAThread]
		public static void  Main(String[] args)
		{
	    	...
	    	if (filename == null)
			{
				System.Console.Out.WriteLine("Usage: Laobai.Lucene.Index.IndexReader [-extract] <cfsfile>");
				return ;
			}
	    ...
	    /// through <see cref="IndexReader.Open(Laobai.Lucene.Store.Directory,bool)" />. Use the parent reader directly. 
	    /// </summary>
