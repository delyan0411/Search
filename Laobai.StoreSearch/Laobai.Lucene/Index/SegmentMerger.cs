...
using FieldSelectorResult = Laobai.Lucene.Documents.FieldSelectorResult;
using FieldOption = Laobai.Lucene.Index.IndexReader.FieldOption;
using MergeAbortedException = Laobai.Lucene.Index.MergePolicy.MergeAbortedException;
...
namespace Laobai.Lucene.Index
{
	...
	public sealed class SegmentMerger
	{
		private class AnonymousClassCheckAbort:CheckAbort
		{
			...
			internal AnonymousClassCheckAbort(SegmentMerger enclosingInstance, Laobai.Lucene.Index.MergePolicy.OneMerge Param1, Laobai.Lucene.Store.Directory Param2):base(Param1, Param2)
			{
		...
		private class AnonymousClassCheckAbort1:CheckAbort
		{
			...
			internal AnonymousClassCheckAbort1(SegmentMerger enclosingInstance, Laobai.Lucene.Index.MergePolicy.OneMerge Param1, Laobai.Lucene.Store.Directory Param2):base(Param1, Param2)
			{
				InitBlock(enclosingInstance);
			}
			public override void  Work(double units)
		...
		{
            ISet<string> fileSet = Laobai.Lucene.Support.Compatibility.SetFactory.CreateHashSet<string>();
