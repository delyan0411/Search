...
using MultiTermDocs = Laobai.Lucene.Index.DirectoryReader.MultiTermDocs;
using MultiTermEnum = Laobai.Lucene.Index.DirectoryReader.MultiTermEnum;
using MultiTermPositions = Laobai.Lucene.Index.DirectoryReader.MultiTermPositions;
...
namespace Laobai.Lucene.Index
{
    ...
    public class MultiReader:IndexReader, System.ICloneable
    {
        ...
        protected internal override void  DoClose()
        {
            ...
            // not a good idea):
            Laobai.Lucene.Search.FieldCache_Fields.DEFAULT.Purge(this);
        }
