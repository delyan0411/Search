...
using ArrayUtil = Laobai.Lucene.Util.ArrayUtil;
using Constants = Laobai.Lucene.Util.Constants;
using IndexSearcher = Laobai.Lucene.Search.IndexSearcher;
...
namespace Laobai.Lucene.Index
{
	...
	public sealed class DocumentsWriter : IDisposable
	{
        ...
        */
        internal class PerDocBuffer : Laobai.Lucene.Store.RAMFile
        {
