...
using BitVector = Laobai.Lucene.Util.BitVector;
...
namespace Laobai.Lucene.Index
{
	...
	public class SegmentReader : IndexReader
	{
			...
			internal void  DecRef()
			{
				lock (this)
				{
					...
					if (ref_Renamed.DecRef() == 0)
					{
                        ...
                        {
                            Laobai.Lucene.Search.FieldCache_Fields.DEFAULT.Purge(origInstance);
                        }
					}
				}
			}
        ...
        public override System.Collections.Generic.ICollection<string> GetFieldNames(IndexReader.FieldOption fieldOption)
		{
            ...
            System.Collections.Generic.ISet<string> fieldSet = Laobai.Lucene.Support.Compatibility.SetFactory.CreateHashSet<string>();
