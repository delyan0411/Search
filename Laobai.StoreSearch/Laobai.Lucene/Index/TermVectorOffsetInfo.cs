...
namespace Laobai.Lucene.Index
{
	...
	/// <summary> The TermVectorOffsetInfo class holds information pertaining to a Term in a <see cref="Laobai.Lucene.Index.TermPositionVector" />'s
	...
	{
		/// <summary> Convenience declaration when creating a <see cref="Laobai.Lucene.Index.TermPositionVector" /> that stores only position information.</summary>
		[NonSerialized]
