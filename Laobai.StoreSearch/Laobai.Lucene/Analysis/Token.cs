...
using System;
using Laobai.Lucene.Analysis.Tokenattributes;
using Laobai.Lucene.Support;
using Laobai.Lucene.Util;
using Payload = Laobai.Lucene.Index.Payload;
using TermPositions = Laobai.Lucene.Index.TermPositions;
using ArrayUtil = Laobai.Lucene.Util.ArrayUtil;
using Attribute = Laobai.Lucene.Util.Attribute;

namespace Laobai.Lucene.Analysis
{
	...
	/// that are part of core Lucene and can be found in the <see cref="Laobai.Lucene.Analysis.Tokenattributes"/> namespace.
	...
	/// <p/>
	/// </summary>
	/// <seealso cref="Laobai.Lucene.Index.Payload">
	/// </seealso>
	[Serializable]
	public class Token : Attribute, ITermAttribute, ITypeAttribute, IPositionIncrementAttribute, IFlagsAttribute, IOffsetAttribute, IPayloadAttribute
	{
	    ...
	    /// <seealso cref="Laobai.Lucene.Index.TermPositions">
	    /// </seealso>
