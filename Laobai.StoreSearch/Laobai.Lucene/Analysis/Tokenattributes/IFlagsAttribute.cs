...
namespace Laobai.Lucene.Analysis.Tokenattributes
{
	...
	public interface IFlagsAttribute:IAttribute
	{
	    ...
	    /// The flags can be used to encode information about the token for use by other <see cref="Laobai.Lucene.Analysis.TokenFilter" />s.
	    /// 
	    /// 
	    /// </summary>
