...
using CharReader = Laobai.Lucene.Analysis.CharReader;
using Token = Laobai.Lucene.Analysis.Token;
using Tokenizer = Laobai.Lucene.Analysis.Tokenizer;
using AttributeSource = Laobai.Lucene.Util.AttributeSource;
using Version = Laobai.Lucene.Util.Version;

namespace Laobai.Lucene.Analysis.Standard
{
	...
	public sealed class StandardTokenizer:Tokenizer
	{
	    ...
	    /// <see cref="Laobai.Lucene.Analysis.Standard.StandardTokenizer" />. Attaches
		...
		/// <see cref="Laobai.Lucene.Util.AttributeSource.AttributeFactory" />
		/// </summary>
		...
		///<summary>
		/// (non-Javadoc)
		/// <see cref="Laobai.Lucene.Analysis.TokenStream.IncrementToken()" />
        ///</summary>
