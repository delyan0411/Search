...
using System;
using System.IO;
using TokenStream = Laobai.Lucene.Analysis.TokenStream;
...
namespace Laobai.Lucene.Documents
{
	...
	public interface IFieldable
	{
        ...
        /// document.
	    /// 
	    /// <p/>The boost is multiplied by <see cref="Laobai.Lucene.Documents.Document.Boost" /> of the document
	    /// containing this field.  If a document has multiple fields with the same
	    /// name, all such values are multiplied together.  This product is then
	    /// used to compute the norm factor for the field.  By
	    /// default, in the <see cref="Laobai.Lucene.Search.Similarity.ComputeNorm(String,Laobai.Lucene.Index.FieldInvertState)"/>
	    /// method, the boost value is multiplied
	    /// by the <see cref="Laobai.Lucene.Search.Similarity.LengthNorm(String,int)"/>
	    /// and then rounded by <see cref="Laobai.Lucene.Search.Similarity.EncodeNorm(float)" /> before it is stored in the
        ...
        /// Documents returned from <see cref="Laobai.Lucene.Index.IndexReader.Document(int)" /> and
        /// <see cref="Laobai.Lucene.Search.Searcher.Doc(int)" /> may thus not have the same value present as when
        /// this field was indexed.
        /// 
	    /// </summary>
	    /// <seealso cref="Laobai.Lucene.Documents.Document.Boost">
	    /// </seealso>
	    /// <seealso cref="Laobai.Lucene.Search.Similarity.ComputeNorm(String, FieldInvertState)">
	    /// </seealso>
	    /// <seealso cref="Laobai.Lucene.Search.Similarity.EncodeNorm(float)">
	    /// </seealso>
	    float Boost { get; set; }
	    ...
	    /// vector, available from <see cref="Laobai.Lucene.Index.IndexReader.GetTermFreqVector(int,String)" />.
	    /// These methods do not provide access to the original content of the field,
	    /// only to terms used to index it. If the original content must be
	    /// preserved, use the <c>stored</c> attribute instead.
	    /// 
	    /// </summary>
	    /// <seealso cref="Laobai.Lucene.Index.IndexReader.GetTermFreqVector(int, String)">
	    /// </seealso>
	    ...
	    /// it's values via <see cref="StringValue()" /> or <see cref="GetBinaryValue()" /> is only valid as long as the <see cref="Laobai.Lucene.Index.IndexReader" /> that
	    ...
	    /// <see cref="Laobai.Lucene.Search.PhraseQuery"/> or 
	    /// <see cref="Laobai.Lucene.Search.Spans.SpanQuery"/> 
