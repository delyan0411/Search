...
using CachingTokenFilter = Laobai.Lucene.Analysis.CachingTokenFilter;
using TokenStream = Laobai.Lucene.Analysis.TokenStream;
using DateField = Laobai.Lucene.Documents.DateField;
using DateTools = Laobai.Lucene.Documents.DateTools;
...
using FuzzyQuery = Laobai.Lucene.Search.FuzzyQuery;
using MatchAllDocsQuery = Laobai.Lucene.Search.MatchAllDocsQuery;
using MultiPhraseQuery = Laobai.Lucene.Search.MultiPhraseQuery;
using MultiTermQuery = Laobai.Lucene.Search.MultiTermQuery;
...
using WildcardQuery = Laobai.Lucene.Search.WildcardQuery;
...
namespace Laobai.Lucene.QueryParsers
{
    ...
    /// <see cref="Laobai.Lucene.Documents.DateTools.Resolution" /> has to be set.
    /// <p/>
    /// <p/>
    ...
    public class QueryParser : QueryParserConstants
    {
        ...
        /// <summary>Parses a query string, returning a {@link Laobai.Lucene.Search.Query}.</summary>
        ...
        /// <summary> Command line tool to test QueryParser, using {@link Laobai.Lucene.Analysis.SimpleAnalyzer}.
        /// Usage:<br/>
        /// <c>java Laobai.Lucene.QueryParsers.QueryParser &lt;input&gt;</c>
        /// </summary>
        [STAThread]
