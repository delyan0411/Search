		...
		private sealed class TimerThread:ThreadClass
		{
			...
			override public void  Run()
			{
				while (true)
				{
					...
					time += Laobai.Lucene.Search.TimeLimitingCollector.resolution;
					System.Threading.Thread.Sleep(new System.TimeSpan((System.Int64) 10000 * Laobai.Lucene.Search.TimeLimitingCollector.resolution));
