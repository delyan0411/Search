...
using BooleanClause = Laobai.Lucene.Search.BooleanClause;
using BooleanQuery = Laobai.Lucene.Search.BooleanQuery;
using DisjunctionMaxQuery = Laobai.Lucene.Search.DisjunctionMaxQuery;
using FilteredQuery = Laobai.Lucene.Search.FilteredQuery;
using MultiPhraseQuery = Laobai.Lucene.Search.MultiPhraseQuery;
using PhraseQuery = Laobai.Lucene.Search.PhraseQuery;
using Query = Laobai.Lucene.Search.Query;
using TermQuery = Laobai.Lucene.Search.TermQuery;
using SpanNearQuery = Laobai.Lucene.Search.Spans.SpanNearQuery;
using SpanOrQuery = Laobai.Lucene.Search.Spans.SpanOrQuery;
