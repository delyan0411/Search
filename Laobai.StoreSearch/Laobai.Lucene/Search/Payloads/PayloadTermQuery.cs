...
using TermPositions = Laobai.Lucene.Index.TermPositions;
...
using SpanTermQuery = Laobai.Lucene.Search.Spans.SpanTermQuery;
using SpanWeight = Laobai.Lucene.Search.Spans.SpanWeight;
using TermSpans = Laobai.Lucene.Search.Spans.TermSpans;

namespace Laobai.Lucene.Search.Payloads
{
	
	/// <summary> This class is very similar to
	/// <see cref="Laobai.Lucene.Search.Spans.SpanTermQuery" /> except that it factors
	/// in the value of the payload located at each of the positions where the
	/// <see cref="Laobai.Lucene.Index.Term" /> occurs.
	/// <p/>
	/// In order to take advantage of this, you must override
    /// <see cref="Laobai.Lucene.Search.Similarity.ScorePayload(int, String, int, int, byte[],int,int)" />
