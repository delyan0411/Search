...
namespace Laobai.Lucene.Search
{
    ...
    /// <item> <see cref="Laobai.Lucene.Search.Spans.SpanQuery" /> </item>
	/// </list>
	/// <p/>A parser for queries is contained in:
	/// <list type="bullet">
    /// <item><see cref="Laobai.Lucene.QueryParsers.QueryParser">QueryParser</see> </item>
	/// </list>
	/// </summary>
	[Serializable]
	public abstract class Query : System.ICloneable
	{
		...
		/// by <see cref="Laobai.Lucene.QueryParsers.QueryParser">QueryParser</see>. However,
