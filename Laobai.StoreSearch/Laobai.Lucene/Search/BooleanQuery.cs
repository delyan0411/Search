...
using Occur = Laobai.Lucene.Search.Occur;
...
namespace Laobai.Lucene.Search
{
	...
	public class BooleanQuery : Query, System.Collections.Generic.IEnumerable<BooleanClause>, System.ICloneable
	{
		...
		private class AnonymousClassSimilarityDelegator:SimilarityDelegator
		{
			...
			internal AnonymousClassSimilarityDelegator(BooleanQuery enclosingInstance, Laobai.Lucene.Search.Similarity Param1):base(Param1)
			{
		...
		public class TooManyClauses:System.SystemException
		{
			public override System.String Message
			{
				get
				{
					return "maxClauseCount is set to " + Laobai.Lucene.Search.BooleanQuery._maxClauses;
				}
