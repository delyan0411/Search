...
{
	/// <summary> A base class for all collectors that return a <see cref="Laobai.Lucene.Search.TopDocs" /> output. This
	...
	public abstract class TopDocsCollector<T> : Collector where T : ScoreDoc
	{
        ...
        /// <summary> Returns a <see cref="Laobai.Lucene.Search.TopDocs" /> instance containing the given results. If
        ...
        /// with the returned <see cref="Laobai.Lucene.Search.TopDocs" /> object, which will contain all the
        ...
        /// returned <see cref="Laobai.Lucene.Search.TopDocs" /> object, which will contain all the results this
