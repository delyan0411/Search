...
namespace Laobai.Lucene.Search
{
	...
	public class FilteredQuery:Query
	{
		...
		{
			public AnonymousClassWeight(Laobai.Lucene.Search.Weight weight, Laobai.Lucene.Search.Similarity similarity, FilteredQuery enclosingInstance)
			{
				InitBlock(weight, similarity, enclosingInstance);
			}
			private class AnonymousClassScorer:Scorer
			{
				private void  InitBlock(Laobai.Lucene.Search.Scorer scorer, Laobai.Lucene.Search.DocIdSetIterator docIdSetIterator, AnonymousClassWeight enclosingInstance)
				{
					this.scorer = scorer;
					this.docIdSetIterator = docIdSetIterator;
					this.enclosingInstance = enclosingInstance;
				}
				private Laobai.Lucene.Search.Scorer scorer;
				private Laobai.Lucene.Search.DocIdSetIterator docIdSetIterator;
				...
				internal AnonymousClassScorer(Laobai.Lucene.Search.Scorer scorer, Laobai.Lucene.Search.DocIdSetIterator docIdSetIterator, AnonymousClassWeight enclosingInstance, Laobai.Lucene.Search.Similarity Param1):base(Param1)
				{
			...
			private void  InitBlock(Laobai.Lucene.Search.Weight weight, Laobai.Lucene.Search.Similarity similarity, FilteredQuery enclosingInstance)
			{
				this.weight = weight;
				this.similarity = similarity;
				this.enclosingInstance = enclosingInstance;
			}
			private Laobai.Lucene.Search.Weight weight;
			private Laobai.Lucene.Search.Similarity similarity;
