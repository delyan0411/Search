...
using QueryParser = Laobai.Lucene.QueryParsers.QueryParser;
...
namespace Laobai.Lucene.Search
{
	...
	public abstract class MultiTermQuery:Query
	{
		...
		public class AnonymousClassConstantScoreAutoRewrite:ConstantScoreAutoRewrite
		{
			...
			{
				return Laobai.Lucene.Search.MultiTermQuery.CONSTANT_SCORE_AUTO_REWRITE_DEFAULT;
			}
		}
		...
		private sealed class ConstantScoreFilterRewrite:RewriteMethod
		{
			...
			{
				return Laobai.Lucene.Search.MultiTermQuery.CONSTANT_SCORE_FILTER_REWRITE;
			}
		}
		...
		private class ScoringBooleanQueryRewrite:RewriteMethod
		{
			...
			protected internal virtual System.Object ReadResolve()
			{
				return Laobai.Lucene.Search.MultiTermQuery.SCORING_BOOLEAN_QUERY_REWRITE;
			}
		}
		...
		private class ConstantScoreBooleanQueryRewrite:ScoringBooleanQueryRewrite
		{
			...
			{
				return Laobai.Lucene.Search.MultiTermQuery.CONSTANT_SCORE_BOOLEAN_QUERY_REWRITE;
			}
		}
