...
namespace Laobai.Lucene.Search
{
	...
	public class QueryWrapperFilter:Filter
	{
		...
		{
			public AnonymousClassDocIdSet(Laobai.Lucene.Search.Weight weight, Laobai.Lucene.Index.IndexReader reader, QueryWrapperFilter enclosingInstance)
			{
				InitBlock(weight, reader, enclosingInstance);
			}
			private void  InitBlock(Laobai.Lucene.Search.Weight weight, Laobai.Lucene.Index.IndexReader reader, QueryWrapperFilter enclosingInstance)
			{
				this.weight = weight;
				this.reader = reader;
			...
			private Laobai.Lucene.Index.IndexReader reader;
