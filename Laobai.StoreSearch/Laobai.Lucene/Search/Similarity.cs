...
using FieldInvertState = Laobai.Lucene.Index.FieldInvertState;
using Term = Laobai.Lucene.Index.Term;
using SmallFloat = Laobai.Lucene.Util.SmallFloat;
using IDFExplanation = Laobai.Lucene.Search.Explanation.IDFExplanation;
...
namespace Laobai.Lucene.Search
{
    ...
    /// <see cref="Laobai.Lucene.Search.DefaultSimilarity.Tf(float)">DefaultSimilarity</see> is:
	/// 
	/// <br/>&#160;<br/>
	/// <table cellpadding="2" cellspacing="2" border="0" align="center">
	/// <tr>
	/// <td valign="middle" align="right" rowspan="1">
    /// <see cref="Laobai.Lucene.Search.DefaultSimilarity.Tf(float)">tf(t in d)</see> &#160; = &#160;
	/// </td>
    ...
    /// <see cref="Laobai.Lucene.Search.DefaultSimilarity.Idf(int, int)">DefaultSimilarity</see> is:
	/// 
	/// <br/>&#160;<br/>
	/// <table cellpadding="2" cellspacing="2" border="0" align="center">
	/// <tr>
	/// <td valign="middle" align="right">
    /// <see cref="Laobai.Lucene.Search.DefaultSimilarity.Idf(int, int)">idf(t)</see>&#160; = &#160;
	/// </td>
    ...
    /// <see cref="Laobai.Lucene.Search.DefaultSimilarity.QueryNorm(float)">DefaultSimilarity</see>
	/// is:
	/// <br/>&#160;<br/>
	/// <table cellpadding="1" cellspacing="0" border="0" align="center">
	/// <tr>
	/// <td valign="middle" align="right" rowspan="1">
	/// queryNorm(q)  &#160; = &#160;
    /// <see cref="Laobai.Lucene.Search.DefaultSimilarity.QueryNorm(float)">queryNorm(sumOfSquaredWeights)</see>
	/// &#160; = &#160;
	/// </td>
	...
	/// computed by the query <see cref="Laobai.Lucene.Search.Weight" /> object.
	/// For example, a <see cref="Laobai.Lucene.Search.BooleanQuery">boolean query</see>
	...
	/// <tr>
	/// <td valign="middle" align="right" rowspan="1">
    /// <see cref="Laobai.Lucene.Search.Weight.GetSumOfSquaredWeights">GetSumOfSquaredWeights</see> &#160; = &#160;
    /// <see cref="Laobai.Lucene.Search.Query.Boost">q.Boost</see> <sup><big>2</big></sup>
	/// &#160;&#183;&#160;
	/// </td>
	/// <td valign="bottom" align="center" rowspan="1">
	/// <big><big><big>&#8721;</big></big></big>
	...
	/// <see cref="Laobai.Lucene.Search.Query.Boost" />.
	/// Notice that there is really no direct API for accessing a boost of one term in a multi term query,
	/// but rather multi terms are represented in a query as multi
	/// <see cref="Laobai.Lucene.Search.TermQuery">TermQuery</see> objects,
    ...
    /// <see cref="Laobai.Lucene.Documents.Document.Boost">doc.Boost</see>
	...
	/// <see cref="Laobai.Lucene.Store.Directory">directory</see> and
	...
	/// </seealso>
	/// <seealso cref="Laobai.Lucene.Index.IndexWriter.Similarity">
	/// </seealso>
	...
	public abstract class Similarity
	{
	    ...
	    /// <seealso cref="Searcher.Similarity">
	    /// </seealso>
	    /// <seealso cref="Laobai.Lucene.Index.IndexWriter.SetSimilarity(Similarity)">
	    /// </seealso>
		...
		/// <see cref="Laobai.Lucene.Index.IndexWriter.AddDocument(Laobai.Lucene.Documents.Document)" /> 
		...
		/// </summary>
		/// <seealso cref="Laobai.Lucene.Documents.AbstractField.Boost" />
		/// <seealso cref="Laobai.Lucene.Util.SmallFloat" />
		...
		/// <see cref="Laobai.Lucene.Index.IndexReader.NumDocs()" /> because it is
