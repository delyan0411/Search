...
namespace Laobai.Lucene.Search.Function
{
	...
	/// <see cref="Laobai.Lucene.Search.FieldCache">FieldCache</see> using getStringIndex()
	...
	public class ReverseOrdFieldSource:ValueSource
	{
		private class AnonymousClassDocValues:DocValues
		{
			...
			/* (non-Javadoc) <see cref="Laobai.Lucene.Search.Function.DocValues.strVal(int) */
		...
		/*(non-Javadoc) <see cref="Laobai.Lucene.Search.Function.ValueSource.getValues(Laobai.Lucene.Index.IndexReader) */
		public override DocValues GetValues(IndexReader reader)
		{
			Laobai.Lucene.Search.StringIndex sindex = Laobai.Lucene.Search.FieldCache_Fields.DEFAULT.GetStringIndex(reader, field);
