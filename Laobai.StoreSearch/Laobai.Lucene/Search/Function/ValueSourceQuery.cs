...
namespace Laobai.Lucene.Search.Function
{
	...
	/// values obtained from a <see cref="Laobai.Lucene.Search.Function.ValueSource">ValueSource</see>.
	/// <p/>
	...
	public class ValueSourceQuery:Query
	{
		...
		internal class ValueSourceWeight:Weight
		{
			...
			/*(non-Javadoc) <see cref="Laobai.Lucene.Search.Weight.explain(Laobai.Lucene.Index.IndexReader, int) */
        ...
        private class ValueSourceScorer : Scorer
        {
            ...
            /*(non-Javadoc) <see cref="Laobai.Lucene.Search.Scorer.explain(int) */
