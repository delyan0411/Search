...
namespace Laobai.Lucene.Search.Function
{
	...
	/// a single field from the <see cref="Laobai.Lucene.Search.FieldCache">FieldCache</see>.
	/// <p/>
	...
	public abstract class FieldCacheSource:ValueSource
	{
		...
		{
			return GetCachedFieldValues(Laobai.Lucene.Search.FieldCache_Fields.DEFAULT, field, reader);
		}
