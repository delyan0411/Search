...
using ComplexExplanation = Laobai.Lucene.Search.ComplexExplanation;
...
namespace Laobai.Lucene.Search.Function
{
	...
	/// <see cref="Laobai.Lucene.Search.Function.FieldScoreQuery">FieldScoreQuery</see></item>
	/// </list>
	...
	public class CustomScoreQuery:Query, System.ICloneable
	{
		...
		/// <see cref="Laobai.Lucene.Search.Function.FieldScoreQuery">FieldScoreQuery</see>.
		...
		/// <see cref="Laobai.Lucene.Search.Function.FieldScoreQuery">FieldScoreQueries</see>.
		/// This parameter is optional - it can be null or even an empty array.
		/// </param>
		...
		/*(non-Javadoc) <see cref="Laobai.Lucene.Search.Query.rewrite(Laobai.Lucene.Index.IndexReader) */
		...
		/*(non-Javadoc) <see cref="Laobai.Lucene.Search.Query.extractTerms(java.util.Set) */
		...
		/*(non-Javadoc) <see cref="Laobai.Lucene.Search.Query.clone() */
		...
		/* (non-Javadoc) <see cref="Laobai.Lucene.Search.Query.toString(java.lang.String) */
		...
		private class CustomWeight:Weight
		{
			...
			/*(non-Javadoc) <see cref="Laobai.Lucene.Search.Weight.getQuery() */
		    ...
		    /*(non-Javadoc) <see cref="Laobai.Lucene.Search.Weight.getValue() */
		    ...
		    /*(non-Javadoc) <see cref="Laobai.Lucene.Search.Weight.sumOfSquaredWeights() */
		    ...
		    /*(non-Javadoc) <see cref="Laobai.Lucene.Search.Weight.normalize(float) */
		...
		private class CustomScorer:Scorer
		{
			...
			/*(non-Javadoc) <see cref="Laobai.Lucene.Search.Scorer.score() */
