...
namespace Laobai.Lucene.Search
{
	...
	/// <c>Searcher</c> (<see cref="Laobai.Lucene.Search.Query.CreateWeight(Searcher)" />).</item>
	...
	public abstract class Weight
	{
		...
		/// </summary>
		/// <param name="reader">
        /// the <see cref="IndexReader" /> for which to return the <see cref="Laobai.Lucene.Search.Scorer" />.
		/// </param>
        ...
        /// if true, <see cref="Laobai.Lucene.Search.Scorer.Score(Laobai.Lucene.Search.Collector)" /> will be called; if false,
	    ...
	    /// <see cref="Scorer(Laobai.Lucene.Index.IndexReader, bool, bool)" /> to
